...
echo "http POST authorization:token REDACTED title=$title detail_url=$detail_url description=@$file_path"
http POST "authorization:token $ATOM_TWEAKS_API_KEY" "title=$title" "detail_url=$detail_url" "description=@$file_path"
